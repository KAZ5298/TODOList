...
<body>
    ...
    <div class="container">
        ...
        <div class="pagination">
            <!-- 戻る -->
            <?php if ($now_page >= 2) : ?>
                <a href="./index.php?page_id=<?= $now_page - 1 ?>" class="page_feed">&laquo;</a>
            <?php else : ?>
            ...
            <?php for ($i = 1; $i <= $max_page; $i++) : ?>
                <?php if ($i >= $now_page - $range && $i <= $now_page + $range) : ?>
                    ...
                    <?php else : ?>
                        <a href="./index.php?page_id=<?= $i ?>" class="page_number"><?= $i ?></a>
                    <?php endif ?>
                <?php endif ?>
            <?php endfor ?>
            ...
            <?php if ($now_page < $max_page) : ?>
                <a href="./index.php?page_id=<?= $now_page + 1 ?>" class="page_feed">&raquo;</a>
            <?php else : ?>
